...
class _CreateChannelSheetState extends State<CreateChannelSheet> {
  ...
  bool _validate() {
    ...
    if (hp.isNotEmpty) {
      ...
      if (uri == null || uri.host.isEmpty || !uri.host.contains('.')) {
        setState(() => _homepageError = 'URL 형식이 올바르지 않습니다 (예: example.com)');
        ok = false;
      } else {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      padding: EdgeInsets.fromLTRB(20, 16, 20, MediaQuery.of(context).viewInsets.bottom + MediaQuery.of(context).padding.bottom + 24),
