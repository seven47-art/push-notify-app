...
/* ── 로딩 풀스크린 (Flutter WebView 진입 시 세션 주입 전 표시) ── */
#auth-screen {
...
<!-- ══ 로딩 화면 (Flutter WebView 세션 주입 전 표시) ══ -->
<div id="auth-screen">
  <!-- 로딩 전용 로고 -->
  <div class="auth-logo-wrap">
    <div class="auth-logo-icon">
      <img src="/static/splash_logo.png" style="width:200px;object-fit:contain;display:block;">
    </div>
  </div>
  <!-- 로딩 스피너 -->
  <div style="margin-top:48px;">
    <i class="fas fa-spinner spin" style="font-size:24px;color:#FF9A3C;"></i>
  </div>
...
<div id="screen-wrap" style="display:none;">
  ...
  <div class="screen" id="screen-inbox">
    <!-- 헤더: 고정 높이, 레이아웃 밀림 없음 -->
    <div id="inbox-header" class="section-header" style="flex-shrink:0;position:relative;min-height:52px;">
      <!-- 일반 모드 -->
      <div id="inbox-header-normal" style="display:flex;align-items:center;width:100%;">
      ...
      <!-- 편집 모드: absolute overlay → 헤더 높이 변화 없음 -->
      <div id="inbox-action-bar" style="display:none;position:absolute;inset:0;align-items:center;padding:0 16px;gap:10px;background:var(--bg2);z-index:2;">
        ...
        <span id="inbox-selected-count" style="font-size:13px;color:var(--text3);margin-left:2px;">0개 선택</span>
        <button onclick="App.deleteSelectedInbox()" style="margin-left:auto;padding:5px 14px;background:#EF4444;color:#fff;border:none;border-radius:8px;font-size:13px;font-weight:600;cursor:pointer;">삭제</button>
        <button onclick="App.toggleInboxEditMode()" style="padding:5px 14px;background:var(--bg3);color:var(--text);border:none;border-radius:8px;font-size:13px;cursor:pointer;">취소</button>
      </div>
    </div>
    <!-- 채널 필터 (고정) -->
  ...
  <div class="screen" id="screen-send">
    <!-- 헤더: 고정 높이, 레이아웃 밀림 없음 -->
    <div id="outbox-header" class="section-header" style="flex-shrink:0;position:relative;min-height:52px;">
      <!-- 일반 모드 -->
      <div id="outbox-header-normal" style="display:flex;align-items:center;width:100%;">
      ...
      <!-- 편집 모드: absolute overlay → 헤더 높이 변화 없음 -->
      <div id="outbox-action-bar" style="display:none;position:absolute;inset:0;align-items:center;padding:0 16px;gap:10px;background:var(--bg2);z-index:2;">
        <label style="display:flex;align-items:center;gap:6px;font-size:13px;color:var(--text2);cursor:pointer;">
        ...
        <span id="outbox-selected-count" style="font-size:13px;color:var(--text3);margin-left:2px;">0개 선택</span>
        <button onclick="App.deleteSelectedOutbox()" style="margin-left:auto;padding:5px 14px;background:#EF4444;color:#fff;border:none;border-radius:8px;font-size:13px;font-weight:600;cursor:pointer;">삭제</button>
        <button onclick="App.toggleOutboxEditMode()" style="padding:5px 14px;background:var(--bg3);color:var(--text);border:none;border-radius:8px;font-size:13px;cursor:pointer;">취소</button>
      </div>
    </div>
    <!-- 채널 필터 (고정) -->
