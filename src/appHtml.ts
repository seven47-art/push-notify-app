...
/* ── 채널 타일 (운영) ── */
.channel-list-wrap { margin:0 14px; background:var(--bg2); border-radius:12px; border:1px solid var(--border); overflow:hidden; }
...
/* ── 가입 채널 타일 ── */
.joined-list-wrap { margin:0 14px; background:var(--bg2); border-radius:12px; border:1px solid var(--border); overflow:hidden; }
...
/* ── 채널 리스트 아이템 (전체채널) ── */
.ch-all-list-wrap { margin:4px 14px; background:var(--bg2); border-radius:12px; border:1px solid var(--border); overflow:hidden; }
...
<script src="/static/mobile-app.js?v=202603101300"></script>
</body>
</html>`;
